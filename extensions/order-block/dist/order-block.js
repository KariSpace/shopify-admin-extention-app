(() => {
  ...
  // extensions/order-block/src/BlockExtension.jsx
  var import_react19 = __toESM(require_react());

  // extensions/order-block/src/AddressGroup.jsx
  var import_react18 = __toESM(require_react());

  // extensions/order-block/src/AddressBlock.jsx
  var import_react17 = __toESM(require_react());

  // app/assets/statusBadges.json
  var statusBadges_default = {
    completed: "success",
    signed: "success",
    cancelled: "critical",
    declined: "critical",
    "waiting for pharmacy": "info",
    "waiting for doctor": "info",
    "Accepted by pharmacy": "info",
    approved: "info",
    success: "success",
    error: "warning",
    oos: "warning",
  ...
  function AddressBlock({ addressData }) {
    ...
    function filterAddress(address, addressStructure2) {
      const filteredAddress2 = {};
      addressStructure2.forEach((property) => {
        if (address.hasOwnProperty(property)) {
          filteredAddress2[property] = address[property];
        }
      });
      console.log(filteredAddress2);
      return filteredAddress2;
    }
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockStack2, { padding: "base", children: addressStructure.map((key) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(InlineStack2, { blockAlignment: "start", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockStack2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Text2, { fontWeight: "bold", children: [
        key,
        ":"
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockStack2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: filteredAddress[key] }) })
    ] }, key)) }) });
  }

  // extensions/order-block/src/AddressGroup.jsx
  var import_jsx_runtime5 = __toESM(require_jsx_runtime());
  function AddressGroup({ order, orderId }) {
    const [isLoading, setIsLoading] = (0, import_react18.useState)(false);
    const [deliveryAddress, setDeliveryAddress] = (0, import_react18.useState)(order == null ? void 0 : order.deliveryAddress);
    const [invoiceAddress, setInvoiceAddress] = (0, import_react18.useState)(order == null ? void 0 : order.invoiceAddress);
    let handleClick = function() {
      return __async(this, null, function* () {
        setIsLoading(true);
        const response = yield fetch(`/api/order/${orderId}/sync`);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(InlineStack2, { gap: true, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Box2, { padding: "base", children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Heading2, { size: "4", children: "Delivery address" }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(AddressBlock, { addressData: deliveryAddress })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Box2, { padding: "base", children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Heading2, { size: "4", children: "Invoice address" }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(AddressBlock, { addressData: invoiceAddress })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Button2, { isLoading, fullWidth: true, onClick: handleClick, children: isLoading ? "Fetching the data..." : "Sync" })
    ] });
  }
  ...
  var BlockExtension_default = reactExtension(TARGET, () => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(App, {}));
  function App() {
    const { i18n, data } = useApi(TARGET);
    const [loading, setLoading] = (0, import_react19.useState)(true);
    const [order, setOrder] = (0, import_react19.useState)(null);
    const [error, setError2] = (0, import_react19.useState)(null);
    const [orderId, setOrderId] = (0, import_react19.useState)(null);
    (0, import_react19.useEffect)(() => {
      (function fetchOrder() {
        return __async(this, null, function* () {
          ...
          setOrderId(order_id);
          const response = yield fetch(`/api/order/${order_id}`);
          const orderData = yield response.json();
          console.log(orderData);
          if (orderData.status === "error") {
            setError2(orderData.message);
          } else {
            setOrder(orderData);
          }
          setLoading(false);
    ...
    if (loading) {
      return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(InlineStack2, { blockAlignment: "center", inlineAlignment: "center", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ProgressIndicator2, { size: "large-100" }) });
    }
    if (error) {
      return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(AdminBlock2, { title: "Order", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Text2, { tone: "critical", children: error }) });
    }
    console.log(statusBadges_default);
    return (
      // The AdminBlock component provides an API for setting the title of the Block extension wrapper.
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(AdminBlock2, { title: "Order", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(BlockStack2, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(InlineStack2, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Box2, { minInlineSize: 400, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(Text2, { fontWeight: "bold", children: [
            "UID: ",
            order.uid
          ] }) }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(BlockStack2, { inlineAlignment: "end", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Badge2, { tone: statusBadges_default[order.status], children: order.status }) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(AddressGroup, { order, orderId })
      ] }) })
    );
  }
})();
//# sourceMappingURL=order-block.js.map
